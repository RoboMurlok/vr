...
export default function Contactos() {
  ...
  return (
    <div className="page">
      ...
      <section>
        <div className="text">
          <h3>Plataformas sociales</h3>
          <p>
            Cómo formular objetivos y planificar un presupuesto sin
            sobrecargarse: pasos sencillos.
          </p>
          <a href="https://t.me/artcasbeauty" target="_blank">
            Telegram (canal de actualizaciones)
          </a>
          <a href="https://instagram.com/artcasbeauty" target="_blank">
            Instagram (anuncios y notas)
          </a>
        </div>
        <div className="text">
          <h3>Dirección</h3>
